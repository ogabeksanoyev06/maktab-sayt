...
<template>
	<div class="pb-8 md:pb-16">
		...
		<div class="container">
			<UIImage
				src="'https://tmci.uz/files/cache/03/07/03074b9ae3d74d7d28a0ededf06180cb.jpg'"
				image-class="rounded-lg mx-auto mt-1.5 md:mt-3 mb-3 md:mb-11 overflow-hidden object-cover w-full block max-w-[984px] aspect-[984/540] h-full"
			/>
				...
				<div class="space-y-2 md:space-y-5 hidden-print">
					...
					<div class="flex flex-col-reverse gap-3 md:flex-row items-center justify-between">
						<div class="flex justify-between max-sm:flex-col md:justify-auto gap-3 md:gap-5 w-full">
							<CommonButtonShare :title="'Ulashish'" />
							<CommonButtonCopy />
						</div>
