	...
	<div class="overflow-hidden">
		...
		<div class="container pt-5">
			...
			<div class="flex flex-col gap-3">
				<h2 class="text-2xl md:text-3xl font-bold">Tadbirlar va ekskursiyalar</h2>
			...
			<div class="max-w-[1200px] mx-auto">
				<UIImage src="/images/image.jpg" image-class="rounded mx-auto mt-1.5 md:mt-6 mb-3 md:mb-11 overflow-hidden object-cover w-full h-auto" />
