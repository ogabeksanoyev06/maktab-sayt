<template>
	<div ref="dropdown" class="relative z-20" data-dropdown="0" tabindex="0">
		<div :class="headClass" @click="toggleShow" class="cursor-pointer">
			<slot name="head"></slot>
		</div>
		<transition name="dropdown" mode="out-in">
			<div
				v-show="showBody"
				:class="[bodyClass, fullWidth ? 'fixed left-0 right-0' : 'absolute right-0 w-max min-w-full translate-y-full -bottom-1 overflow-hidden shadow-sm rounded']"
