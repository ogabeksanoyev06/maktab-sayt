<template>
	<div class="py-4 md:py-8 bg-[#F5F7FA]">
		<div class="bg-[linear-gradient(109.6deg,_#005EFE_0.88%,_#003898_100.96%)] relative">
			...
			<div class="container relative py-8 md:py-16">
				<div class="pb-8 sm:pb-16 md:w-1/2">
				...
				<div class="grid grid-cols-12 gap-5 relative z-1 sm:w-fit">
					<div
						v-for="(item, index) in list"
						:key="index"
						class="p-4 glass-card sm:max-w-[260px] w-full rounded-[20px] flex flex-col items-start col-span-6 sm:col-span-4 max-sm:last:col-start-4"
					>
				...
				<img class="max-md:hidden h-4/5 lg:h-full aspect-[528/580] absolute bottom-0 right-0 z-0" src="/images/home/kids.webp" alt="Kids image" />
			</div>
		</div>
	</div>
</template>
